...
%-----------------  a= imagen de entrada             ---------------------
%-----------------  c= imagen de salida              ---------------------
%-----------------  se devuelve el m�ximo de b,y y c ---------------------
%-------------------------------------------------------------------------
...
%
    ...
    % Se busca la capa que tenga valor máximo en su componente correspondiente
    c=max(b,y);c=max(c,s);
    % devuelve la capa de color que mayor valor tenga
    c=reshape([c,c,c],[fil,col,cap]);
